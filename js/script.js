  ...
  documentMouseMoveHandler: function (e) {
    var boid,
      ...
      vector = new THREE.Vector3(
        e.clientX - offset.x - this.halfViewWidth,
        -e.clientY - offset.y + this.halfViewHeight,
        0
      );
...
var Main = function (win) {
  ...
  if (!Modernizr.canvas) {
    mainEl.innerHTML =
      '<p class="unsupport">Your browser doesn\'t support HTML5 Canvas. This demo requires a modern browser which support HTML5 Canvas to run.<br> Please consider using <a href="https://www.google.com/chrome">Google Chrome</a>, <a href="http://www.mozilla.org/en-US/firefox/new/">Firefox</a>.</p>';
    return;
  }
  ...
  boidScene.init(doc.getElementById("fish-frame"), 12, true);
  boidScene.animate();
